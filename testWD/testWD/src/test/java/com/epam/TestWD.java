...
public class TestWD {
    ...
    public void oneCanCheckAddSeat() throws InterruptedException {
        ...
        System.out.println(steps.takeTotalPriceForPassengerWithSeats());
        System.out.println(steps.takePriceForPassengerWithSeatsFromTable());
    }
    ...
    public void oneCanFindCar() {
        steps.enterCarParameters(CITYOFARRIVLE);
