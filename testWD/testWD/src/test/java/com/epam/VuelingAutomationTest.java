...
public class VuelingAutomationTest {
    ...
    public void oneCanCheckWrightPriceForTwoPassengerFlightOneWay() {
        ...
        Assert.assertEquals((steps.takePriceFromWebSiteFor1Passenger() * NUMBER_OF_PASSENGER), steps.takeTotalPriceForAllPassenger());
    }
    ...
    public void oneCanCheckRightPriceForTwoPassengerFlightWithReturn() {
        ...
        Assert.assertEquals((steps.takePriceFromWebSiteFor1Passenger() * NUMBER_OF_PASSENGER) + steps.takeBookingFee(), steps.takeFinalPrice());
    }
